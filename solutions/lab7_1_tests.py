...
class TestLab7(unittest.TestCase):
   ...
   def setUp(self):
      self.good_url ='http://computingconcepts.herokuapp.com'
      self.bad_url = 'http://www.dylanmedina.com'
      self.unfixible_url = 'http://www.dylanmedina.horse'
   ...
   def test_requests_user_agent_bad_user_agent(self):
      self.assertIsNone(target.request_user_agent(self.good_url, None))
