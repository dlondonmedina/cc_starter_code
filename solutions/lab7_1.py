...
def basic_request(url):
   if url_verify(url) == None:
      return None 
   resp = requests.get(url) 
   return resp.status_code

# Create a function called request_user_agent() that will take two 
# parameters.
...
# Create a function called request_post() that takes a url and 
